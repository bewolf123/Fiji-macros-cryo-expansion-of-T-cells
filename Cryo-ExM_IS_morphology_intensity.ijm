...
//----Get total Florescence intensity of the protein of interest ---------------------------------------------
					...
					for (channel = 0; channel < staining_nb; channel++) {
						...
						selectWindow(staining[channel]);					
						run("Z Project...", "start=Z0 stop=Z1 projection=[Sum Slices]"); // SUM Z projection of the synaptic plan (Z0 to Z1)
						makeRectangle(10, 11, 38, 38);
...
selectWindow("Total_Intensity_Results");
saveAs("Results", dir_result+"Total_Intensity_Results2.csv");	
}

showMessage("Your analysis is done, please get some rest");				